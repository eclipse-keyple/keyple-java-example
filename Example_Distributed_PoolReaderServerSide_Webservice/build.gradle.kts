...
dependencies {
    ...
    implementation("org.eclipse.keyple:keyple-distributed-local-java-lib:2.3.0-SNAPSHOT") { isChanging = true }
    implementation("org.eclipse.keyple:keyple-distributed-remote-java-lib:2.3.0-SNAPSHOT") { isChanging = true }
