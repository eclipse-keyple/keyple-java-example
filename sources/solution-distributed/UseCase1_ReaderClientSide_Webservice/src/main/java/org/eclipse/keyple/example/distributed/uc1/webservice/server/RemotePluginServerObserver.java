...
import org.eclipse.keyple.example.distributed.uc1.webservice.util.CalypsoTicketingService;
...
public class RemotePluginServerObserver implements PluginObserverSpi {
  ...
  private Object executeCalypsoSessionFromRemoteSelection(
    ...
    // service.
    UserInputDataDto userInputData = readerExtension.getInputData(UserInputDataDto.class);

    // Performs a remote explicit selection.
    CardSelectionManager cardSelectionManager = CalypsoTicketingService.getCardSelection();
