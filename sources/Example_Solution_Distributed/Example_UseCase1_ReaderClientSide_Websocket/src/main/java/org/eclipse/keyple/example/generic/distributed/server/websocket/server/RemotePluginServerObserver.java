 ...
 ************************************************************************************** */
package org.eclipse.keyple.example.generic.distributed.server.websocket.server;
...
import org.eclipse.keyple.example.generic.distributed.server.websocket.util.CalypsoTicketingService;
import org.eclipse.keyple.example.generic.distributed.server.websocket.util.UserInputDataDto;
import org.eclipse.keyple.example.generic.distributed.server.websocket.util.UserOutputDataDto;
...
public class RemotePluginServerObserver implements ObservablePlugin.PluginObserver {
  ...
  private Object executeCalypsoSessionFromRemoteSelection(RemoteReaderServer reader) {
    ...
    CardSelectionsResult cardSelectionResult = cardSelection.processExplicitSelections(reader);
    CalypsoCard calypsoCard = (CalypsoCard) cardSelectionResult.getActiveSmartCard();

    // Read the content of event log file.
    try {
      CalypsoTicketingService.readEventLog(calypsoCard, reader);
