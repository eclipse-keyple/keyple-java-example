...
dependencies {
    ...
    implementation("org.eclipse.keyple:keyple-service-java-lib:2.1.4") { isChanging = true }
    ...
    implementation("org.eclipse.keyple:keyple-distributed-remote-java-lib:2.2.0")
