...
// Begin Keyple configuration (generated by 'https://keyple.org/components/overview/configuration-wizard/')
    ...
    implementation("org.eclipse.keyple:keyple-card-calypso-crypto-legacysam-java-lib:0.6.0")
    implementation("org.eclipse.keyple:keyple-card-calypso-crypto-pki-java-lib:0.1.0")
