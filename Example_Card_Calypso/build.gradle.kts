...
dependencies {
    ...
    implementation("org.calypsonet.terminal:calypsonet-terminal-calypso-crypto-legacysam-java-api:0.1.0-SNAPSHOT") { isChanging = true }
    ...
    implementation("org.eclipse.keyple:keyple-card-calypso-crypto-legacysam-java-lib:0.1.0-SNAPSHOT") { isChanging = true }
