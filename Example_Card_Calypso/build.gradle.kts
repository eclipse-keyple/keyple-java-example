...
dependencies {
    ...
    implementation("org.eclipse.keypop:keypop-calypso-crypto-legacysam-java-api:0.5.0-SNAPSHOT") { isChanging = true }
    ...
    implementation("org.eclipse.keyple:keyple-plugin-pcsc-java-lib:2.2.0-PERF-SNAPSHOT")
    implementation("org.eclipse.keyple:keyple-plugin-stub-java-lib:2.2.0")
    implementation("org.eclipse.keyple:keyple-card-calypso-crypto-legacysam-java-lib:0.6.0-SNAPSHOT") { isChanging = true }
    implementation("org.eclipse.keyple:keyple-card-calypso-java-lib:3.1.0-SNAPSHOT") { isChanging = true }
    implementation("org.eclipse.keyple:keyple-card-calypso-crypto-pki-java-lib:0.1.0-SNAPSHOT") { isChanging = true }
