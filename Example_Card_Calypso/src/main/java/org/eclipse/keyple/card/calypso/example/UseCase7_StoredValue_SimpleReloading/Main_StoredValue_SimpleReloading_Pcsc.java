...
/**
 * Handles the process of reloading the Stored Value (SV) of a Calypso card using the PC/SC plugin
 * and the Calypso Card Extension Service.
 *
 * <p>This class demonstrates the SV reloading process outside a Secure Session. It includes the
 ...
 *   <li>Reloading of the Calypso Card Stored Value.
 * </ul>
 *
...
public class Main_StoredValue_SimpleReloading_Pcsc {
  ...
  public static void main(String[] args) {
    ...
    cardTransaction.prepareSvReload(2).processCommands(ChannelControl.CLOSE_AFTER);
