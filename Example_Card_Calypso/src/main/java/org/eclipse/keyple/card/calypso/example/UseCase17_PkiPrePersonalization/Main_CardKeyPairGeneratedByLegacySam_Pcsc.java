 ...
 *
 * <p>The card ECC key pair is generated by the SAM allowing a pre-computation of all data to be
 * injected into the card. Be aware that it is less secure than the method where the key is
 * generated by the card, and it is sensitive to man in the middle attacks.
 *
 ...
 * console.
 */
public class Main_CardKeyPairGeneratedByLegacySam_Pcsc {
  private static final Logger logger =
      LoggerFactory.getLogger(Main_CardKeyPairGeneratedByLegacySam_Pcsc.class);
  ...
  public static void main(String[] args) {
    ...
    logger.info(
        "= UseCase Calypso #17-2: PKI card initialization with a SAM C1 ==================");
    ...
    calypsoCardApiFactory
        ...
        // Execute all prepared commands on the Calypso card and close the channel afterward
